...
import vasanthImg from '../assets/vasanth-ai.jpeg';
import './Hero.css';
      ...
      <div className="container hero-inner">
        ...
        <div className="hero-content">
          ...
          <div className="hero-social animate-fade-in-up delay-6">
            <a href="https://www.linkedin.com/in/vasanthkumarbm/" target="_blank" rel="noreferrer" className="social-link" aria-label="LinkedIn">
